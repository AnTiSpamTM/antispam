...
local function run(msg,matches)
 ...
 if matches[1] == "mycontact" and is_sudo(msg) then
	...
	if matches[1] == '🔃' then
		...
		reload_plugins(true)
		post_msg(receiver, "✔️ربات با موفقیت ریستارت شد✔️", ok_cb, false)
		return
	end
	--[[*For Debug*
...
--By @Hosein_MSUDO :)
--https://github.com/AnTiSpamTM/antispambot/tree/supergroups
---Modified by @AnTiSpamTM for supergroups
